...
for(let i = 0; i < products.length; i++){
    const productDescription = `<p class="card-text animate__animated animate__bounceInUp">${products[i].description}</p>`;
    

    div.innerHTML += `
         <div class="row">
         <div class="col-md-3 p-3">
         <div class="card" style="width: 15rem; height : 210px; background-color:yellow; border-radius:10px;">
            <div class="card-body">
